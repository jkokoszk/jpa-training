...
-- books
insert into book (id, title, version, library_id) values (1, 'Nie mów nikomu', 0, 1);
insert into book (id, title, version, library_id) values (2, 'Wszyscy mamy tajemnice', 0, 1);
insert into book (id, title, version, library_id) values (3, 'Schronienie', 0, 1);
insert into book (id, title, version, library_id) values (4, 'Mistyfikacja', 0, 1);

insert into book (id, title, version, library_id) values (5, 'Rogacz z urojenia', 0, 2);
insert into book (id, title, version, library_id) values (6, 'Szkoła mężów', 0, 2);
insert into book (id, title, version, library_id) values (7, 'Szkoła żon', 0, 2);
insert into book (id, title, version, library_id) values (8, 'Świętoszek', 0, 3);
