...
-- authors
insert into author (id, type, birth_date, first_name, last_name, nick_name, literary_genre) values (2, 'WRITER', TO_DATE('1622/01/15', 'YYYY/MM/DD'), 'Jean', 'Popuelin', 'Molier', 'COMEDY');
